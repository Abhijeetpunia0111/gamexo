...
import { SPORTS, courtsForSport, sportById, type Draft } from '../../data/booking'
...
export default function SelectSportCourt({
  ...
  const sport = sportById(draft.sportId || '')
  const courts = courtsForSport(draft.sportId || '')
                ...
                <div className="flex w-full flex-col items-start gap-2.5">
                  ...
                  {expanded === court.id && (
                    <p className="mt-1 text-sm text-[#606060]">
                      Open {court.hours} · fits up to {court.capacity} players
                    </p>
                  )}
                </div>
              </button>
